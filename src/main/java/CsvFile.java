...
public class CsvFile {
    ...
    public static void main(String[]args) throws IOException {
        ...
        PrintWriter pw = null;
        try {
            pw = new PrintWriter(new File("C:\\Users\\Inclusiv Academy16\\Desktop\\Asa\\FbPost.csv"));
        ...
        s.close();;
        //-----------------end add text---------------------//
        String columnNamesList = "ACCOUNT,ACCOUNT_ID,POST_TEXT,POST_ID,DATE,LIKE,LOVE,CARE,DISLIKE,COMMENTS,SHARES";
